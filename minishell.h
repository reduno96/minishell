...
char		**ft_double_and_sigle(t_splitor **tmp_x, t_environment *my_env, int j,
				char ***arr_join);
void		ft_join_double(char ***join, t_splitor **tmp_x, t_environment *my_env,
				int j);
char		**ft_word(t_splitor **tmp_x, t_environment *my_env, int j,
				char ***arr_arg);
void		ft_join_words(char ***join, t_splitor **tmp_x, t_environment *my_env,
				int j);
void		ft_join_word_2(char ***join, t_splitor **tmp_x, t_environment *my_env,
				int j);
