SRC= minishell.c \
	...
	ft_execut_cmd/execute_1.c ft_execut_cmd/execute_2.c   ft_execut_cmd/signal.c   ft_execut_cmd/ft_export_2.c ft_execut_cmd/ft_export_1.c      ft_execut_cmd/ft_herdoc_1.c \
